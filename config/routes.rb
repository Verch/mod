Modernimport::Application.routes.draw do
  ...
  match "/futbolki/:id" => "product_types#show"
  match "/rubashki-polo/:id" => "product_types#show"
  match "/tolstovki/:id" => "product_types#show"
  match "/beysbolki/:id" => "product_types#show"
